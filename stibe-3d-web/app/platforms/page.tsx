...
export default function Platforms() {
  return (
    <div className="flex flex-col">
      ...
      <section className="bg-white px-6">
        <div className="container mx-auto max-w-7xl pt-16 md:pt-24">
          <motion.div
            ...
            className="text-left"
          >
            <h2 className="heading-section text-black mb-4 md:mb-6">The Integrated Platform</h2>
            <p className="text-body-premium text-neutral-600 max-w-3xl leading-relaxed mb-8 md:mb-12 text-base md:text-lg">
            ...
            <motion.div 
              ...
              className="bg-black/5 border border-black/10 rounded-3xl p-6 md:p-10 mb-8 md:mb-12 transition-all duration-700 hover:-translate-y-2 hover:shadow-2xl hover:shadow-black/5 hover:bg-white hover:border-transparent group cursor-default"
            >
              <h3 className="text-lg md:text-xl font-bold text-black mb-8 flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-accent/10 flex items-center justify-center group-hover:scale-110 group-hover:bg-accent transition-all duration-500">
                  <Target size={20} className="text-accent group-hover:text-white transition-colors duration-500" />
                </div>
      ...
      <section className="py-16 md:py-24 px-4 md:px-6 bg-white overflow-x-clip relative">
        <div className="container mx-auto max-w-7xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="w-full mt-8 lg:mt-0">
              <div className="bg-[#F8F9FC] p-3 md:p-8 rounded-[32px] md:rounded-[40px] border border-black/5 shadow-2xl relative w-full aspect-square md:aspect-auto flex items-center justify-center group overflow-hidden">
                <img src="/integration-workflow.webp" alt="CRM and LMS Integration Flow" className="rounded-2xl md:rounded-3xl w-full h-auto object-cover max-h-[700px] transition-transform duration-700 group-hover:scale-105" />
      ...
      <section className="py-16 md:py-24 px-4 md:px-6 bg-[#F8F9FC] border-t border-black/5">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              >
                <div 
                  className="w-full h-full grid transition-[transform] duration-700 ease-[cubic-bezier(0.23,1,0.32,1)] group-hover:[transform:rotateY(180deg)]"
