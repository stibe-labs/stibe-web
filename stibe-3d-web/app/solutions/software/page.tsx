...
import { Layers, Smartphone, Layout, Cpu, ArrowRight, ChevronRight } from 'lucide-react';
...
const solutions = [
  {
    ...
    desc: 'Robust, scalable, and fully integrated enterprise software systems designed to streamline business operations across every department.',
    features: [
      'End-to-end ERP systems',
      'CRM & HRMS platforms',
      'Admission CRM systems',
      'LMS frameworks',
  ...
  },
  {
    ...
    desc: 'Advanced mobile applications that enable businesses to deliver seamless digital experiences and optimize operations on the go.',
    features: [
  ...
  },
  {
    ...
    desc: 'Enterprise-grade web platforms and digital infrastructure designed to support operations and scalable digital ecosystems.',
    features: [
  ...
  },
  {
    icon: Cpu,
    title: 'AI & Automation',
    desc: 'Artificial intelligence and automation integrated into business processes for efficiency, accuracy, and intelligent decision-making.',
    features: [
      'AI chatbots & engagement bots',
    ...
    <div className="flex flex-col">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          <motion.div initial="hidden" animate="show" variants={{ show: { transition: { staggerChildren: 0.1 } } }}>
            <motion.span variants={fadeUp} className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-black/5 border border-black/[0.08] text-neutral-700 text-sm mb-6">
              <Layers size={14} /> Software Solutions
            </motion.span>
            ...
            <motion.p variants={fadeUp} className="text-body-premium text-neutral-600 max-w-3xl leading-relaxed">
              Enterprise software, mobile applications, web infrastructure, and AI-powered automation — engineered to run your entire digital operation.
            </motion.p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-14 px-6 relative overflow-x-clip">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            <video
              src="/software-solution-main.mp4"
              autoPlay
              muted
              loop
              playsInline
