...
export default function CinematicVideoSection() {
  return (
    <section className="py-[var(--section-padding)] px-0 overflow-x-clip bg-white flex justify-center">
      <motion.div
        initial={{ opacity: 0, scale: 0.98 }}
        whileInView={{ opacity: 1, scale: 1 }}
        viewport={{ once: true, amount: 0.2 }}
        transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
        className="relative w-[95vw] aspect-[21/9] md:aspect-[16/7] rounded-[32px] bg-black overflow-hidden shadow-2xl border-[8px] md:border-[12px] border-black group"
      >
